...
static int pl110_emulator_read(struct vmm_emudev *edev,
			       ...
			       void *dst, u32 dst_len)
{
	...
	rc = pl110_reg_read(s, offset & ~0x3, &regval);
	if (!rc) {
...
static int pl110_emulator_write(struct vmm_emudev *edev,
				physical_addr_t offset, 
				void *src, u32 src_len)
{
	...
	return pl110_reg_write(s, offset & ~0x3, regmask, regval);
}
...
static struct vmm_emulator pl110_emulator = {
	...
	.read = pl110_emulator_read,
	.write = pl110_emulator_write,
