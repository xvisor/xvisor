 ...
 * @brief Implementation of SHA-256 Hash
 *
 * Derivative work of
 * https://github.com/B-Con/crypto-algorithms/blob/master/sha256_test.c
 *
 * There is no specific licensing giving in original source.
 */
...
static void sha256_transform(struct sha256_context *ctx, u8 data[])
{
