 ...
 *
 * @file s1_hugepage_s2_page_nordwr.c
 * @author Anup Patel (anup@brainfault.org)
 * @brief s1_hugepage_s2_page_nordwr test implementation
 *
 * This tests the handling of no-read-write hugepages in stage1 page
 * tables and pages in stage2 page tables.
 */
...
#define MODULE_DESC			"s1_hugepage_s2_page_nordwr test"
#define MODULE_AUTHOR			"Anup Patel"
#define MODULE_LICENSE			"GPL"
#define MODULE_IPRIORITY		(WBOXTEST_IPRIORITY+1)
#define MODULE_INIT			s1_hugepage_s2_page_nordwr_init
#define MODULE_EXIT			s1_hugepage_s2_page_nordwr_exit

static int s1_hugepage_s2_page_nordwr_run(struct wboxtest *test,
...
static struct wboxtest s1_hugepage_s2_page_nordwr = {
	.name = "s1_hugepage_s2_page_nordwr",
	.run = s1_hugepage_s2_page_nordwr_run,
};

static int __init s1_hugepage_s2_page_nordwr_init(void)
{
	return wboxtest_register("nested_mmu", &s1_hugepage_s2_page_nordwr);
}

static void __exit s1_hugepage_s2_page_nordwr_exit(void)
{
	wboxtest_unregister(&s1_hugepage_s2_page_nordwr);
}
