...
if [ ! -d ${BUILD_XVISOR_DISK_PATH} ]; then
	...
	${BUILD_XVISOR_OUTPUT_PATH}/tools/dtc/dtc -I dts -O dtb -o ${BUILD_XVISOR_DISK_PATH}/images/${BUILD_XVISOR_TESTS_DIR}/${BUILD_XVISOR_GUEST_DTS_BASENAME}.dtb ${BUILD_XVISOR_SOURCE_PATH}/tests/${BUILD_XVISOR_TESTS_DIR}/${BUILD_GUEST_TYPE}/${BUILD_XVISOR_GUEST_DTS_BASENAME}.dts
	if [ "${BUILD_LINUX_CPATCH}" == "yes" ]; then
	...
	if [ ! -z "${BUILD_LINUX_DTB_NAME}" ]; then
		${BUILD_XVISOR_OUTPUT_PATH}/tools/dtc/dtc -I dts -O dtb -p 0x800 -o ${BUILD_XVISOR_DISK_PATH}/images/${BUILD_XVISOR_TESTS_DIR}/${BUILD_GUEST_TYPE}/${BUILD_LINUX_DTB_NAME} ${BUILD_LINUX_DTS_PATH}
	fi
