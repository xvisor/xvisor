...
if [ ! -d ${BUILD_XVISOR_DISK_BASIC_PATH} ]; then
	...
	dtc -I dts -O dtb -o ${BUILD_XVISOR_DISK_BASIC_PATH}/images/${BUILD_XVISOR_TESTS_DIR}/${BUILD_XVISOR_GUEST_DTS_BASENAME}.dtb ${BUILD_XVISOR_GUEST_DTS_PATH}
...
if [ ! -d ${BUILD_XVISOR_DISK_LINUX_PATH} ]; then
	...
	dtc -I dts -O dtb -o ${BUILD_XVISOR_DISK_LINUX_PATH}/images/${BUILD_XVISOR_TESTS_DIR}/${BUILD_XVISOR_GUEST_DTS_BASENAME}.dtb ${BUILD_XVISOR_GUEST_DTS_PATH}
	if [ "${BUILD_LINUX_CPATCH}" == "yes" ]; then
	...
	if [ ! -z "${BUILD_XVISOR_LINUX_DTS_PATH}" ]; then
		dtc -I dts -O dtb -o ${BUILD_XVISOR_DISK_LINUX_PATH}/images/${BUILD_XVISOR_TESTS_DIR}/${BUILD_GUEST_TYPE}/${BUILD_LINUX_DTB_NAME} ${BUILD_XVISOR_LINUX_DTS_PATH}
	else
