...
cpu-common-objs-$(CONFIG_VEXT_AMD_SVM)+= vm/amd/amd_intercept.o
cpu-common-objs-$(CONFIG_VEXT_AMD_SVM)+= vm/amd/amd_svm.o
cpu-common-objs-$(CONFIG_VEXT_INTEL_VTX)+= vm/intel/intel_vmcs.o
cpu-common-objs-$(CONFIG_VEXT_INTEL_VTX)+= vm/intel/intel_vmx.o
cpu-common-objs-$(CONFIG_VEXT_INTEL_VTX)+= vm/intel/ivmx_helper.o
cpu-common-objs-$(CONFIG_VEXT_INTEL_VTX)+= vm/intel/intel_intercept.o
