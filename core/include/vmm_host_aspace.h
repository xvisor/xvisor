...
enum vmm_host_memory_flags {
	...
	VMM_MEMORY_IO_DEVICE=0x00000020,
	VMM_MEMORY_DMA_COHERENT=0x00000040,
	VMM_MEMORY_DMA_NONCOHERENT=0x00000080,
};
...
#define VMM_MEMORY_FLAGS_DMA_COHERENT	(VMM_MEMORY_READABLE | \
					 VMM_MEMORY_WRITEABLE | \
					 VMM_MEMORY_EXECUTABLE | \
					 VMM_MEMORY_DMA_COHERENT)

#define VMM_MEMORY_FLAGS_DMA_NONCOHERENT (VMM_MEMORY_READABLE | \
					  VMM_MEMORY_WRITEABLE | \
					  VMM_MEMORY_EXECUTABLE | \
