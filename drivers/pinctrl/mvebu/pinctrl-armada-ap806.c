...
static struct vmm_devtree_nodeid armada_ap806_pinctrl_of_match[] = {
	{ .compatible ="marvell,ap806-pinctrl" },
	{ /* end of list */ },
};

static struct vmm_driver armada_ap806_pinctrl_driver = {
	.name = "armada-ap806-pinctrl",
	.match_table = armada_ap806_pinctrl_of_match,
	.probe = armada_ap806_pinctrl_probe,
};

static int __init armada_ap806_pinctrl_init(void)
{
	return vmm_devdrv_register_driver(&armada_ap806_pinctrl_driver);
}

static void __exit armada_ap806_pinctrl_exit(void)
{
	vmm_devdrv_unregister_driver(&armada_ap806_pinctrl_driver);
}

#define MODULE_DESC			"Marvell Armada AP806 Pin Controller"
#define MODULE_AUTHOR			"Anup Patel"
#define MODULE_LICENSE			"GPL"
#define MODULE_IPRIORITY		1
#define	MODULE_INIT			armada_ap806_pinctrl_init
#define	MODULE_EXIT			armada_ap806_pinctrl_exit
