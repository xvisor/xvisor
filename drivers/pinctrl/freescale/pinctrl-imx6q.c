 ...
 * All right reserved.
 *
 * Originally from Dong Aisheng <dong.aisheng@linaro.org>
 * Ported by Jimmy Durand Wesolowski <jimmy.durand-wesolowski@openwide.fr>
 *
 ...
 *
 * @file pinctrl-imx6q.c
 * @author Jimmy Durand Wesolowski (jimmy.durand-wesolowski@openwide.fr)
 * @brief Freescale i.MX6Q pin control driver based on i.MX pinmux core
 */
...
#define DRV_NAME		"imx6q-pinctrl"
#define DRV_VERSION		"1.0"

#define MODULE_DESC		"i.MX6Q pin control driver"
#define MODULE_AUTHOR		"Jimmy Durand Wesolowski"
#define MODULE_LICENSE		"GPL"
#define MODULE_IPRIORITY	(2)
#define MODULE_INIT		imx6q_pinctrl_init
#define MODULE_EXIT		imx6q_pinctrl_exit
...
static struct vmm_driver imx6q_pinctrl_driver = {
	.name = "imx6q-pinctrl",
	.match_table = imx6q_pinctrl_of_match,
...
{
	return vmm_devdrv_register_driver(&imx6q_pinctrl_driver);
}
/* arch_initcall(imx6q_pinctrl_init); */

static void __exit imx6q_pinctrl_exit(void)
{
	vmm_devdrv_unregister_driver(&imx6q_pinctrl_driver);
}
