 ...
 *
 * @file pinctrl-imx25.c
 * @author Jean-Christophe Dubois (jcd@tribudubois.net)
 * @brief i.MX25 pinctrl driver
 *
 * Adapted from Linux Kernel 4.2.0 drivers/pinctrl/freescale/pinctrl-imx25.c
 *
 * Copyright 2013 Eukrea Electromatique <denis@eukrea.com>
 *
...
#define DRV_NAME                "imx25-pinctrl"
#define DRV_VERSION             "1.0"

#define MODULE_DESC             "i.MX25 pin control driver"
#define MODULE_AUTHOR           "Jean-Christophe Dubois"
#define MODULE_LICENSE          "GPL"
#define MODULE_IPRIORITY        (2)
#define MODULE_INIT             imx25_pinctrl_init
#define MODULE_EXIT             imx25_pinctrl_exit
...
#else
static struct vmm_driver imx25_pinctrl_driver = {
#endif
#if 0
	.driver = {
		.name = "imx25-pinctrl",
...
#else
	.name = "imx25-pinctrl",
        .match_table = imx25_pinctrl_of_match,
#endif
...
#else
	return vmm_devdrv_register_driver(&imx25_pinctrl_driver);
#endif
}
#if 0
...
#else
	vmm_devdrv_unregister_driver(&imx25_pinctrl_driver);
#endif
}
#if 0
