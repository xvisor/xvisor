			     ...
			     const struct vmm_devtree_nodeid *devid)
{
	...
	if (!i2c_dev)
		return -ENOMEM;
	vmm_devdrv_set_data(dev, i2c_dev);
	i2c_dev->dev = dev;
...
static int bcm2835_i2c_remove(struct vmm_device *dev)
{
...
#else
static struct vmm_driver bcm2835_i2c_driver = {
	.name	= "i2c-bcm2835",
	.probe  = bcm2835_i2c_probe,
	.remove = bcm2835_i2c_remove,
	.match_table	= bcm2835_i2c_of_match,
};

static int __init bcm2835_i2c_driver_init(void)
{
	return vmm_devdrv_register_driver(&bcm2835_i2c_driver);
}

static void __exit bcm2835_i2c_driver_exit(void)
{
	vmm_devdrv_unregister_driver(&bcm2835_i2c_driver);
}

VMM_DECLARE_MODULE("BCM2835 I2C bus adapter",
		   "Stephen Warren",
		   "GPLv2",
		   (I2C_IPRIORITY + 1),
		   bcm2835_i2c_driver_init,
		   bcm2835_i2c_driver_exit);
#endif
