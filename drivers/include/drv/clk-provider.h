 ...
 * @brief Common device tree based clocking framework header
 *
 ...
 */
#ifndef __CLK_PROVIDER_H
#define __CLK_PROVIDER_H
...
/**
 * Callback operations for hardware clocks; these are to
...
/**
 * Structure to hold init data that's common to all clocks and is
...
/**
 * Handle for traversing from a struct clk to its corresponding
...
/***
 * Aggregate clock of mux, divider and gate clocks
 *
 * @hw:		handle between common and hardware-specific interfaces
...
#if 0 /* FIXME: Not available for now. */
