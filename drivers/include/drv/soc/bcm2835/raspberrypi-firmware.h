 ...
 *
 * @file raspberrypi-firmware.h
 * @author Anup Patel (anup@brainfault.org)
 * @brief RaspberryPi BCM2835 firmware API interface.
 *
...
#ifndef __DRV_SOC_RASPBERRY_FIRMWARE_H__
#define __DRV_SOC_RASPBERRY_FIRMWARE_H__

#include <vmm_types.h>
#include <vmm_devtree.h>

#define RPI_FIRMWARE_IPRIORITY		(1)
...
#endif /* __DRV_SOC_RASPBERRY_FIRMWARE_H__ */
