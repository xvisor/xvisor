 ...
 * @brief Machine interface for the pinctrl subsystem.
 *
 * Adapted from linux/include/linux/pinctrl/machine.h
 *
 ...
 */
#ifndef __PINCTRL_MACHINE_H__
#define __PINCTRL_MACHINE_H__
