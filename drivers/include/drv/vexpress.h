 ...
 * @brief ARM VExpress board interface header
 *
 * Adapted from linux/include/linux/vexpress.h
 *
 * This program is free software; you can redistribute it and/or modify
...
struct vexpress_config_bridge_info {
	const char *name;
	void *(*func_get)(struct vmm_device *dev, struct vmm_devtree_node *node);
...
struct clk *vexpress_osc_setup(struct vmm_device *dev);
void vexpress_osc_of_setup(struct vmm_devtree_node *node);

void vexpress_clk_init(void *sp810_base);
