 ...
 * Returns success (0) or negative errno.
 */
int clk_bulk_enable(int num_clks,
		    const struct clk_bulk_data *clks);
...
static inline struct clk *clk_get(struct vmm_device *dev, const char *id)
{
	return NULL;
}

static inline int clk_bulk_get(struct vmm_device *dev, int num_clks,
			       struct clk_bulk_data *clks)
{
	return 0;
}

static inline struct clk *devm_clk_get(struct vmm_device *dev, const char *id)
{
	return NULL;
}

static inline int devm_clk_bulk_get(struct vmm_device *dev, int num_clks,
				    struct clk_bulk_data *clks)
{
	return 0;
}

static inline struct clk *devm_get_clk_from_child(struct vmm_device *dev,
				struct vmm_devtree_node *np, const char *con_id)
{
	return NULL;
}
...
static inline void devm_clk_put(struct vmm_device *dev, struct clk *clk) {}
...
#else
static inline struct clk *of_clk_get(struct vmm_devtree_node *np, int index)
{
	return VMM_ERR_PTR(VMM_ENOENT);
}
static inline struct clk *of_clk_get_by_name(struct vmm_devtree_node *np,
					     const char *name)
{
	return VMM_ERR_PTR(VMM_ENOENT);
}
static inline struct clk *of_clk_get_from_provider(
