...
drivers-objs-$(CONFIG_MMC_SUNXI) += mmc/host/sunxi_mmc.o
drivers-objs-$(CONFIG_MMC_SDHCI) += mmc/host/sdhci.o
drivers-objs-$(CONFIG_MMC_SDHCI_BCM2835) += mmc/host/sdhci-bcm2835.o
drivers-objs-$(CONFIG_MMC_SDHCI_ESDHC_IMX) += mmc/host/sdhci-esdhc-imx.o
drivers-objs-$(CONFIG_MMC_SDHCI_XENON) += mmc/host/sdhci-xenon.o
