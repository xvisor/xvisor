 ...
 * All rights reserved.
 *
 * Adapted from Linux Kernel 3.13.6 drivers/spi/spi-imx.c
 *
...
static const struct spi_imx_devtype_data imx1_cspi_devtype_data = {
	.intctrl = mx1_intctrl,
	.config = mx1_config,
	.trigger = mx1_trigger,
...
static const struct spi_imx_devtype_data imx21_cspi_devtype_data = {
...
static const struct spi_imx_devtype_data imx27_cspi_devtype_data = {
...
static const struct spi_imx_devtype_data imx31_cspi_devtype_data = {
...
static const struct spi_imx_devtype_data imx35_cspi_devtype_data = {
...
static const struct spi_imx_devtype_data imx51_ecspi_devtype_data = {
...
static struct vmm_devtree_nodeid spi_imx_devtype[] = {
	{
		.compatible = "fsl,imx1-cspi",
		.data = &imx1_cspi_devtype_data,
	}, {
		.compatible = "fsl,imx21-cspi",
		.data = &imx21_cspi_devtype_data,
	}, {
		.compatible = "fsl,imx27-cspi",
		.data = &imx27_cspi_devtype_data,
	}, {
		.compatible = "fsl,imx31-cspi",
		.data = &imx31_cspi_devtype_data,
	}, {
		.compatible = "fsl,imx35-cspi",
		.data = &imx35_cspi_devtype_data,
	}, {
		.compatible = "fsl,imx51-ecspi",
		.data = &imx51_ecspi_devtype_data,
	}, {
		/* sentinel */
	}
};
...
static struct vmm_driver spi_imx_driver = {
	.name = DRIVER_NAME,
	.match_table = spi_imx_devtype,
	.probe = spi_imx_probe,
...
{
	return vmm_devdrv_register_driver(&spi_imx_driver);
}

static void __exit spi_imx_driver_exit(void)
{
	vmm_devdrv_unregister_driver(&spi_imx_driver);
}

VMM_DECLARE_MODULE("i.MX SPI driver",
