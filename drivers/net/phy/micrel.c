				       ...
				       char *field3, char *field4)
{
	...
	int val4 = -4;
#else
	unsigned int val1 = (unsigned int)-1;
	unsigned int val2 = (unsigned int)-2;
	unsigned int val3 = (unsigned int)-3;
	unsigned int val4 = (unsigned int)-4;
#endif /* 0 */
	int newval;
	int matches = 0;
	...
	if (val1 != (unsigned int)-1)
		newval = ((newval & 0xfff0) | ((val1 / PS_TO_REG) & 0xf) << 0);

	if (val2 != (unsigned int)-2)
		newval = ((newval & 0xff0f) | ((val2 / PS_TO_REG) & 0xf) << 4);

	if (val3 != (unsigned int)-3)
		newval = ((newval & 0xf0ff) | ((val3 / PS_TO_REG) & 0xf) << 8);

	if (val4 != (unsigned int)-4)
				       ...
				       char *field[], u8 numfields)
{
	...
	int val[4] = {-1, -2, -3, -4};
#else
	unsigned int val[4] = {(unsigned int)-1, (unsigned int)-2,
...
MODULE_LICENSE("GPL");
#else
VMM_DECLARE_MODULE("Micrel PHY driver",
